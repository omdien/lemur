...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <title>Coba swaeat allert</title>
</head>
        ...
        <div class="absolute top-0 bottom-0 left-0 right-0 z-10 py-12 transition duration-150 ease-in-out bg-gray-700"
            ...
            <div role="alert" class="container w-11/12 max-w-lg mx-auto md:w-2/3">
                <div class="relative px-5 py-8 bg-white border border-gray-400 rounded shadow-md md:px-10">
                    ...
                    <h1 class="mb-4 font-bold leading-tight tracking-normal text-gray-800 font-lg">Enter Billing Details
                    </h1>
                    <label for="name" class="text-sm font-bold leading-tight tracking-normal text-gray-800">Nama
                        Gambar</label>
                    <input id="name"
