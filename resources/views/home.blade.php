                    ...
                    <section class="h-screen">
                        <div class="h-full">
                            ...
                            <div class="flex flex-wrap items-center justify-center h-full g-6 lg:justify-between">
                                <div
                                    class="mb-12 shrink-1 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12">
                                ...
                                <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                                    <form method="post" action="/login">
                                        ...
                                        <div
                                            ...
                                            <p class="mx-4 mb-0 font-semibold text-center dark:text-white">
                                                Or
                                            </p>
                                        </div>
