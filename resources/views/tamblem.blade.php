        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="/lembur" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <label for="supel_id"
                                class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Surat Perintah
                                Lembur</label>
                        ...
                        <div class="text-sm font-medium text-gray-500">Waktu dan Tempat</div>
                        ...
                        <div class="relative mb-8 basis-1/2">
